 ...
 */
final class Version20230607132420 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reparacion (id INT AUTO_INCREMENT NOT NULL, nro_orden_manual VARCHAR(255) DEFAULT NULL, agente VARCHAR(255) NOT NULL, estado VARCHAR(255) NOT NULL, equipo VARCHAR(255) NOT NULL, departamento_area VARCHAR(255) NOT NULL, asignado_a VARCHAR(255) NOT NULL, fecha_inicio DATETIME NULL, fecha_fin DATETIME DEFAULT NULL, notificado VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', carga VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE servicio (id INT AUTO_INCREMENT NOT NULL, nro_orden_manual VARCHAR(255) DEFAULT NULL, agente VARCHAR(255) NOT NULL, estado VARCHAR(255) NOT NULL, equipo VARCHAR(255) NOT NULL, departamento_area VARCHAR(255) NOT NULL, asignado_a VARCHAR(255) NOT NULL, fecha_inicio DATETIME NULL, fecha_fin DATETIME DEFAULT NULL, tipo VARCHAR(255) NOT NULL, notificado VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', carga VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
